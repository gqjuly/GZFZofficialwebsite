...
var LR_websiteid = 'DCT63403838';
var LR_imgurl = 'http://dct.zoosnet.net/';
var LR_ssl = 0;
var LR_lng = 'cn';
var LR_js_pm = 'd';
var LR_isMobile = 0;
var LiveReceptionCode_isonline = 1;
var LR_siteid = '63403838';
var LR_sysurl = 'http://dct.zoosnet.net/';
var LR_9ce4d='FF2E451BC7454DFE8C5E3F082A2DCDF4';LR_9ce4d=LR_9ce4d.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_99b28=LR_9ce4d.replace(/1/g,'3').replace(/0/g,'2');var LR_EAAB=LR_99b28.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&CAOI='+LR_EAAB;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://dct.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
