	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www2.53kf.com/webCompany.php?arg=10103424&style=1&kflist=off&kf=55238baa99327c2d44bcea60&zdkf_type=2&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fsg1.cybervoice.cn%2F&keyword=&brief=&logo=&question=&uid=52d4db46dc396c714e7d46d55ac34806";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'http://www2.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"acc_title\" class=\"Lelem\" minheight=\"100\" minwidth=\"100\" maxheight=\"400\" maxwidth=\"400\" style=\"    position: relative; z-index: 10000;\"><div style=\"display: block; cursor: default; position: absolute; top: 46px; left: 5px; z-index: 10001; width: 390px; height: 202px;\" type=\"img\" class=\"Lelem\"><img src=\"http://www2.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_6.png\" style=\"width: 390px; height: 202px;\"></div><div class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 59px; left: 19px; z-index: 10002; width: 111px; height: 22px; color: rgb(255, 255, 255);\"><span iseditable=\"1\" style=\"vertical-align: top; font-family: 宋体; font-size: 15.4px; line-height: 22px; color: rgb(255, 255, 255); font-weight: bold;\">中医中药祛斑</span></div><div style=\"display: block; cursor: pointer; position: absolute; top: 66px; left: 369px; z-index: 10003; width: 10px; height: 8px;\" operating=\"CLOSE\" type=\"img\" class=\"Lelem\"><img src=\"http://www2.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_4.png\" style=\"width: 10px; height: 8px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 91px; left: 19px; z-index: 10004; width: 129px; height: 135px;\" type=\"img\" class=\"Lelem\"><img src=\"http://www2.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_11.png\" style=\"width: 129px; height: 135px;\"></div><div style=\"display: block; cursor: default; position: absolute; top: 100px; left: 163px; z-index: 10005; width: 85px; height: 23px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; color: rgb(255, 255, 255); font-size: 16.1px; line-height: 23px; font-family: 黑体; font-weight: bold;\" iseditable=\"1\">欢迎咨询！</span></div><div style=\"display: block; cursor: default; position: absolute; top: 128px; left: 167px; z-index: 10006; width: 226px; height: 17px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; font-size: 12px; line-height: 17px; color: rgb(255, 255, 255); font-family: 宋体;\" iseditable=\"1\">感谢您的支持！</span></div><div style=\"display: block; cursor: default; position: absolute; top: 149px; left: 167px; z-index: 10007; width: 184px; height: 17px; color: rgb(255, 255, 255);\" type=\"text\" class=\"Lelem\"><span style=\"vertical-align: top; font-family: 宋体; font-size: 12px;\" iseditable=\"1\">请问有什么可以帮您？</span></div><div class=\"Lelem\" type=\"img\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; top: 184px; left: 164px; z-index: 10008; width: 107px; height: 34px;\"><img style=\"width: 107px; height: 34px;\" src=\"http://www2.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_41.png\"></div><div class=\"Lelem\" type=\"text\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 193px; left: 285px; z-index: 10009; width: 60px; height: 17px;\"><span operating=\"CLOSE\" iseditable=\"1\" style=\"vertical-align: top; color: #FFF; font-family: 宋体; text-decoration: underline; font-size: 12px;\">下次再说</span></div></div>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
            ...
            if(1 == 1){
                ...
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:16px;overflow:hidden;position:absolute;top:7px;left:10px;width:330px;height:20px;color:'+font_color+';text-indent:30px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_7.png) -79px 0 no-repeat;font-weight:bold;font-family:Arial;">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:10px;right:46px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min.png?11) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:10px;right:28px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto.gif) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:10px;right:10px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_7.png) -18px 0 no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;margin:0 2px;height:35px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_7.png?111) no-repeat;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
                if(7 == 1){
                    tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:16px;overflow:hidden;position:absolute;top:7px;left:10px;width:330px;height:20px;color:#fff;text-indent:30px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_7.png) -79px 0 no-repeat;font-weight:bold;font-family:Arial;">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:10px;right:46px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min.png?11) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:10px;right:28px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto.gif) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:10px;right:10px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_7.png) -18px 0 no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:403px;height:35px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_7.png?111) no-repeat;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
                }
            ...
            if(1 == 8){
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:15px;overflow:hidden;position:absolute;top:18px;left:30px;width:230px;height:18px;color:#fff;text-indent:25px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_dz1.png) -79px 0 no-repeat;font-weight:bold;font-family:Arial;">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:20px;right:46px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min.png?11) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:20px;right:28px;width:12px;height:13px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:20px;right:10px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_dz1.png) -18px 0 no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:320px;height:50px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz1.png?111) no-repeat;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 9){
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:15px;overflow:hidden;position:absolute;top:8px;left:10px;width:230px;height:18px;color:#c9a67f;text-indent:2px;font-family:微软雅黑,arial">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:12px;right:46px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min.png) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:12px;right:28px;width:12px;height:13px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:12px;right:10px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/close.png) no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:370px;height:35px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz1.png) no-repeat; border-top-right-radius: 6px;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 10) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="font-size:14px;  font-weight: bold;overflow:hidden;position:absolute;top:10px;left:20px;width:230px;height:18px;color:#525c63;text-indent:2px;font-family:微软雅黑,arial">' + hz6d_cname + '</div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:1px;right:76px;width:39px;height:29px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min_llt.png) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:1px;right:39px;width:37px;height:29px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto_llt.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:1px;right:8px;width:31px;height:29px;background:url(http://www2.53kf.com/style/chat/minichat2/img/close_llt.png) no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;height:41px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz1.png) no-repeat; border-top-right-radius: 6px;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 12) {
             ...
             if(1 == 13) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="hz6d_cname_mini_div" style="display:none;position:absolute;top:10px;left:20px;"></div><div title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:16px;right:52px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min13.png) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:12px;right:28px;width:13px;height:13px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto13.png) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div title="&#20851;&#38381;" style="position:absolute;top:12px;right:8px;width:12px;height:12px;background:url(http://www2.53kf.com/style/chat/minichat2/img/close13.png) no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="border: 1px solid #E2E2E2;border-top-right-radius: 5px;border-top-left-radius: 5px;width:278px;height:31px;background-color:#F1F1F1;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 15) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div class="img_logo_show" style="position: absolute;top:-10px;left:20px;z-index: 11;"><img class="icon-login" src="http://www2.53kf.com/style/chat/minichat2/img/cube-login.png?1"/></div><div id="hz6d_cname_mini_div" style="font-size:14px;font-weight: bold;position:absolute;top:0px;left:0px;width:100%;height:32px;line-height:32px;padding-left:70px;box-sizing:border-box;color:#fff;text-indent:2px;font-family:微软雅黑,arial;background:#0083FF;border-top-left-radius:10px;border-top-right-radius:10px;font-weight: normal;font-size: 12px;">' + hz6d_cname + '</div><div class="max_return" title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:1px;right:76px;width:39px;height:32px;background:url(http://www2.53kf.com/style/chat/minichat2/img/min.png) center no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div class="mini_maxto" title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:1px;right:39px;width:37px;height:32px;background:url(http://www2.53kf.com/style/chat/minichat2/img/maxto.png) center no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div class="mini_close" title="&#20851;&#38381;" style="position:absolute;top:1px;right:8px;width:31px;height:32px;background:url(http://www2.53kf.com/style/chat/minichat2/img/close.png) center no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;height:32px;background:url(http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz1.png) no-repeat; border-top-right-radius: 6px;"></div><div id="iframe_company_mini_div" style="width:100%;height:415px;border:1px solid #C8C7C6;border-top:0;box-sizing: border-box;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 16){
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="img-show" style="display:inline-block;position:absolute;top:10px;left:15px;"><img src="http://www2.53kf.com/style/chat/minichat2/img/live2.png" style="border-radius:50%;width:45px;"></div><div id="hz6d_cname_mini_div" style="font-size:15px;overflow:hidden;position:absolute;top:20px;left:65px;width:230px;height:18px;color:#000;text-indent:2px;font-family:微软雅黑,arial"> </div><div class="mini_narrow" title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;border-radius:50%;top:22px;right:38px;width:21px;height:20px;background:url(http://www2.53kf.com/style/chat/minichat2/img/minx.jpg) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div class="mini_maxto" title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;border-radius:50%;top:22px;right:70px;width:21px;height:20px;background:url(http://www2.53kf.com/style/chat/minichat2/img/double.jpg) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div class="mini_close" title="&#20851;&#38381;" style="position:absolute;top:22px;right:10px;width:20px;height:20px;background:url(http://www2.53kf.com/style/chat/minichat2/img/close.png) no-repeat 50% 50%;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:330px;height:60px;background:#56C10B;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
			...
			{
				var openurl = "http://www2.53kf.com/webCompany.php?arg=10103424&style=1&kflist=off&kf=55238baa99327c2d44bcea60&zdkf_type=2&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fsg1.cybervoice.cn%2F&keyword=&brief=&logo=&question=&uid=52d4db46dc396c714e7d46d55ac34806&tfrom=2"+force_kf;
				try{
			...
			function cgpic(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
				}
				
			}
			function cgpic2(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
				}
			}
			function cgpic3(t){
				document.querySelector('.mini_maxto').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
			}
			function cgpic4(t){
				document.querySelector('.mini_maxto').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
			}
			function cgpic5(t){
				document.querySelector('.mini_close').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
			}
			function cgpic6(t){
				document.querySelector('.mini_close').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
			}
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
					...
					t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/max.png')";				
                    ...
                    if(1 == 8) {
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz82.png')"; 
                    ...
                    if(1 == 9) {
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg2_5.png')";
                    ...
                    if(1 == 10) {
                        ...
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz10.png')";
						$53("mini_header_bg_div").previousSibling.previousSibling.previousSibling.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/max_llt.png')";
                    ...
                    if(1 == 11) {
                        ...
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz11.png')";
                        t.onmouseover = function() {
                            t.style.background='url(http://www2.53kf.com/style/chat/minichat2/img/maxto_2_3-1.png?2)';
                        }
                        t.onmouseout = function() {
                            t.style.background='url(http://www2.53kf.com/style/chat/minichat2/img/maxto_2-3.png?2)';
                        };
						t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/maxto_2-3.png')";
                    ...
                    if(1 == 13) {
                        ...
                        t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/max13.png')";		
                        t.style.top="13px";
                        return;       
                    }
                    ...
                    if(1 == 14) {
                        ...
                        $53("hz6d_cname_mini_div").style.background = "url('http://www2.53kf.com/style/chat/minichat2/img/1.gif') no-repeat";
                        $53("hz6d_cname_mini_div").onmouseover = function(){
                            this.style.background="url('http://www2.53kf.com/style/chat/minichat2/img/1.gif') no-repeat";
                        }
                    ...
                    if(1 == 15) {
                        ...
                        $53("div_company_mini").style.background="url('http://www2.53kf.com/style/chat/minichat2/img/cube-login.png?1') 8px center no-repeat #e8e8e8";
                    ...
                    if(1 == 16) {
                        ...
                        $53("mini_header_bg_div").style.overflow = "hidden";
                     	document.querySelector(".mini_maxto").style.display="none";
                        document.querySelector(".mini_close").style.display="none";
                        document.querySelector('.mini_narrow').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/max.png') no-repeat 50% 50%";
                        return;       
                    }
                    ...
                    if(1 == 17) {
                        ...
                        $53("mini_header_bg_div").style.overflow = "hidden";
                     	//document.querySelector(".mini_maxto").style.display="none";
                        document.querySelector(".mini_close").style.display="none";
                        document.querySelector('.mini_narrow').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/up.png') no-repeat 50% 50%";
                        document.querySelector('.mini_narrow').style.right="10px";
                        document.querySelector('.logo_img').style.width="23px";
                        document.querySelector('.logo_img').src="http://www2.53kf.com/style/chat/minichat2/img/logo2.png";
                    ...
                    if(1 == 18) {
                        ...
                        //document.querySelector(".mini_close").style.display="none";
                        document.querySelector('.mini_narrow').style.background="url('http://www2.53kf.com/style/chat/minichat2/img/t_cicle.png') no-repeat";
                        //document.querySelector('.mini_narrow_img').src="http://www2.53kf.com/style/chat/minichat2/img/up.png";
                        //document.querySelector('.mini_narrow').style.right="10px";
                        document.querySelector('.logo_img').style.width="23px";
                        document.querySelector('.logo_img').style.top="0px";
                        document.querySelector('.logo_img').src="http://www2.53kf.com/style/chat/minichat2/img/minchat_ns_t2.png";
                        document.querySelector('#hz6d_cname_mini_div').style.display="block";
                        return;  
                    }

                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg2_7.png')";
				}
				else
				{	
					...
					t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/min.png')";
                   ...
                   if(1 == 8) {
                        ...
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz8.png?1111')";
                   ...
                   if(1 == 9) {
                        ...
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz9.png')";
                        return;
                   }
                   ...
                   if(1 == 10) {
						...
						$53("hz6d_cname_mini_div").style.textIndent = "2px";
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz10.png')";
						$53("mini_header_bg_div").previousSibling.previousSibling.previousSibling.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/min_llt.png')";
                        return;
                   }
                    ...
                    if(1 == 11) {
                        ...
                        $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_dz11.png?123')";
                        t.onmouseover = function() {
                            t.style.background='url(http://www2.53kf.com/style/chat/minichat2/img/min_3_3.png?2)';
                        }
                        t.onmouseout = function() {
                            t.style.background='url(http://www2.53kf.com/style/chat/minichat2/img/min_3.png?2)';
                        }
						t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/min_3.png?1')";
                        return;
                   }
                   ...
                   if(1 == 12) {
                    ...
                    if(1 == 13) {
                        ...
                        t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/min13.png')";
                        t.style.top="16px";
                        $53("hz6d_cname_mini_div").innerHTML="";
                        return;
                   }
                   ...
                   if(1 == 14) {
                        ...
                        $53("hz6d_cname_mini").style.background="url(http://www2.53kf.com/style/chat/minichat2/img/m.png?1)  no-repeat"
                        ...
                        $53("hz6d_cname_mini_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/1.png')";
                        $53("hz6d_cname_mini_div").style.backgroundColor="#EEF3F9";
                        $53("hz6d_cname_mini_div").onmouseover = function(){
                            this.style.background="url('http://www2.53kf.com/style/chat/minichat2/img/2.png') no-repeat #EEF3F9";
                        }
                        $53("hz6d_cname_mini_div").onmouseout = function(){
                            this.style.background="url('http://www2.53kf.com/style/chat/minichat2/img/1.png') no-repeat #EEF3F9";
                        }
                        $53("hz6d_cname_mini").onmouseover=function(){
                            this.style.background="url('http://www2.53kf.com/style/chat/minichat2/img/m.png')  no-repeat";
                        }
                        $53("hz6d_cname_mini").onmouseout=function(){
                            this.style.background="url('http://www2.53kf.com/style/chat/minichat2/img/m.png')  no-repeat";
                        }
                   ...
                   if(1 == 15) {
                        ...
                        document.querySelector(".max_return").style.background="url(http://www2.53kf.com/style/chat/minichat2/img/min.png) center no-repeat";
                   ...
                   if(1 == 16) {
						...
						t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/minx.jpg')";
						document.querySelector(".mini_maxto").style.display="block";
                        document.querySelector(".mini_close").style.display="block";
                        return;
                   }
                   ...
                   if(1 == 17) {
                        ...
                        $53("div_company_mini").style.width = "400px";  
						t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/minx2.png')";
						t.style.right="68px";
						document.querySelector('.logo_img').style.width="198px";
                        document.querySelector('.logo_img').src="http://www2.53kf.com/style/chat/minichat2/img/logo1.png";
						//document.querySelector(".mini_maxto").style.display="block";
                   ...
                   if(1 == 18) {
						...
						t.style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/t_cicle.png')";
						t.style.right="68px";
                   ...
                   $53("mini_header_bg_div").style.backgroundImage = "url('http://www2.53kf.com/style/chat/minichat2/img/header_bg_7.png')";
			...
			{
				if(ivt_zdfq == 'yes') {
					//document.cookie = "onliner_zdfq72103424="+onliner_zdfq;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						acpt_force_kf(force_kf);
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=7&interface_theme=5&minchat_style=1';
			...
			function close_company_mini(){	
                ...
                if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72103424="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF': 
								case 'KF': var click_open_url = 'window.open(\"http://www2.53kf.com/webCompany.php?arg=10103424&style=1&kflist=off&kf=55238baa99327c2d44bcea60&zdkf_type=2&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fsg1.cybervoice.cn%2F&keyword=&brief=&logo=&question=&uid=52d4db46dc396c714e7d46d55ac34806&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								click_open_url = encodeURIComponent(click_open_url);
								click_str ='onliner_zdfq=2;hz6d_is_exist(\"'+click_open_url+'\");hidden_ivt();';break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www2.53kf.com/webCompany.php?arg=10103424&style=1&kflist=off&kf=55238baa99327c2d44bcea60&zdkf_type=2&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fsg1.cybervoice.cn%2F&keyword=&brief=&logo=&question=&uid=52d4db46dc396c714e7d46d55ac34806&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE': click_str = 'onliner_zdfq=3;hidden_ivt();'; break;
							case 'ETEL': click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=72103424&style_id=106140979\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
							case 'QQ': 
								if(valst[1])
								{
									if(valst[1].toLowerCase().indexOf('biz') > -1)
									{
										...
										link_str = 'http://www2.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
									}
									else
									{
